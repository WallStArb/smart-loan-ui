...
const ParametersPage: React.FC = () => {
  ...
  const addAuditEntry = (key: string, oldValue: any, newValue: any) => {
    ...
    if (typeof newValue === 'boolean') {
      ...
      iconColor = newValue ? 'text-green-600' : 'text-red-600'
      bgColor = newValue ? 'bg-green-50' : 'bg-red-50'
        ...
        <div className="max-w-7xl mx-auto mb-6">
          <div className="flex items-center justify-between p-4 bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button size="sm" onClick={handleSave} className="h-9 px-4 bg-emerald-600 hover:bg-emerald-700">
                    ...
                    <TooltipTrigger asChild>
                      <div className={cn(
                        ...
                        <div className="flex items-center space-x-2 text-left">
                          <div className="w-4 h-4 bg-emerald-100 border border-emerald-200 rounded-sm flex items-center justify-center">
                      ...
                      <TooltipTrigger asChild>
                        <div className="flex-1 cursor-help">
                          <CustomCheckbox 
                            ...
                            onChange={(checked) => handleInputChange('borrowForDeficitWhenDeliveryExists', checked)}
                          >
                            <div className="flex items-center space-x-2">
              ...
              <CardContent className="p-3 space-y-2">
                ...
                <div className="flex items-center justify-between py-1 px-2 rounded-md hover:bg-gray-50 transition-colors">
                  <CustomCheckbox 
                    ...
                    onChange={(checked) => handleInputChange('reduceByOpenStockLoans', checked)}
                  >
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between py-1 px-2 rounded-md hover:bg-gray-50 transition-colors">
                    <CustomCheckbox 
                      ...
                      onChange={(checked) => handleInputChange('reduceByOpenStockLoanRecall', checked)}
                    >
                      <div className="flex items-center space-x-2">
